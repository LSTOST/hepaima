...
const ALL_QUESTIONS: Question[] = [
  ...
  // 依恋 attachment 12 题
  { id: 58, stage: "STABLE", category: "attachment", text: "在一起久了，伴侣忙工作几天没好好陪你，你通常？", options: [{ key: "A", text: "理解，各自忙完再好好相处", scores: { attachment: { secure: 4 } } }, { key: "B", text: "会有点失落，希望 TA 主动说句「想你了」", scores: { attachment: { anxious: 3 } } }, { key: "C", text: "会怀疑是不是感情淡了、TA 没那么需要我了", scores: { attachment: { fearful: 4 } } }, { key: "D", text: "正好，我也需要自己的时间和空间", scores: { attachment: { avoidant: 4 } } }] },
  { id: 59, stage: "STABLE", category: "attachment", text: "长期相处中，你更看重两个人怎样相处？", options: [{ key: "A", text: "既有共同时间，也尊重彼此独处", scores: { attachment: { secure: 4 } } }, { key: "B", text: "希望经常黏在一起，分开会不踏实", scores: { attachment: { anxious: 4 } } }, { key: "C", text: "保持一定距离，太紧密会喘不过气", scores: { attachment: { avoidant: 4 } } }, { key: "D", text: "想靠近又怕依赖太多会受伤", scores: { attachment: { fearful: 4 } } }] },
  ...
  { id: 61, stage: "STABLE", category: "attachment", text: "谈到见家长、结婚这类「下一步」时，你的反应是？", options: [{ key: "A", text: "愿意一起推进，也会和 TA 商量节奏", scores: { attachment: { secure: 4 } } }, { key: "B", text: "可以，但希望 TA 先表态、给我信心", scores: { attachment: { anxious: 3 } } }, { key: "C", text: "有点压力，怕被绑得太紧", scores: { attachment: { avoidant: 4 } } }, { key: "D", text: "既期待又怕失望，会试探 TA 的想法", scores: { attachment: { fearful: 4 } } }] },
  { id: 62, stage: "STABLE", category: "attachment", text: "遇到工作或生活上的压力，你会和伴侣说吗？", options: [{ key: "A", text: "会，TA 是我最信任的人", scores: { attachment: { secure: 4 } } }, { key: "B", text: "会说一些，但不会全倒", scores: { attachment: { secure: 3 } } }, { key: "C", text: "不太说，怕 TA 觉得我负能量", scores: { attachment: { avoidant: 3 } } }, { key: "D", text: "习惯自己扛，说了也没用", scores: { attachment: { avoidant: 4 } } }] },
  { id: 63, stage: "STABLE", category: "attachment", text: "伴侣和异性同事/朋友走得比较近，你会？", options: [{ key: "A", text: "信任 TA，不会多想", scores: { attachment: { secure: 4 } } }, { key: "B", text: "会问清楚情况，需要 TA 给我安心", scores: { attachment: { anxious: 3 } } }, { key: "C", text: "心里不舒服，但不想显得小气", scores: { attachment: { fearful: 3 } } }, { key: "D", text: "无所谓，我也有自己的圈子", scores: { attachment: { avoidant: 4 } } }] },
  ...
  { id: 65, stage: "STABLE", category: "attachment", text: "伴侣说「最近想一个人待会儿」时，你？", options: [{ key: "A", text: "尊重，等 TA 愿意聊再陪", scores: { attachment: { secure: 4 } } }, { key: "B", text: "会想是不是我哪里做得不好", scores: { attachment: { anxious: 4 } } }, { key: "C", text: "有点受伤，觉得被推开", scores: { attachment: { fearful: 3 } } }, { key: "D", text: "正好，我也需要自己的空间", scores: { attachment: { avoidant: 4 } } }] },
  { id: 66, stage: "STABLE", category: "attachment", text: "稳定期里，你和朋友、家人的联系？", options: [{ key: "A", text: "伴侣和亲友都重要，会平衡", scores: { attachment: { secure: 4 } } }, { key: "B", text: "陪伴侣多了，朋友约有时会推", scores: { attachment: { anxious: 3 } } }, { key: "C", text: "更想和伴侣待着，亲友理解就行", scores: { attachment: { anxious: 4 } } }, { key: "D", text: "还是更需要自己的社交和独处", scores: { attachment: { avoidant: 4 } } }] },
  ...
  { id: 68, stage: "STABLE", category: "attachment", text: "你理想中「稳定期的关系」是？", options: [{ key: "A", text: "彼此信任、有空间也有依靠", scores: { attachment: { secure: 4 } } }, { key: "B", text: "希望 TA 经常表达在乎、让我有安全感", scores: { attachment: { anxious: 4 } } }, { key: "C", text: "保持独立，不要太黏", scores: { attachment: { avoidant: 4 } } }, { key: "D", text: "想依赖又怕依赖，有时会试探", scores: { attachment: { fearful: 4 } } }] },
  ...
  // 爱的语言 loveLanguage 10 题
  { id: 70, stage: "STABLE", category: "loveLanguage", text: "日常里，哪种方式最让你感到被爱？", options: [{ key: "A", text: "TA 说「辛苦了」「有你真好」之类的话", scores: { loveLanguage: { words: 4 } } }, { key: "B", text: "TA 主动分担家务、帮我办事", scores: { loveLanguage: { service: 4 } } }, { key: "C", text: "TA 记得我喜欢的并买回来", scores: { loveLanguage: { gifts: 4 } } }, { key: "D", text: "TA 放下手机，专心陪我聊会儿或待着", scores: { loveLanguage: { time: 4 } } }] },
  { id: 71, stage: "STABLE", category: "loveLanguage", text: "你平时更常怎样向伴侣表达爱？", options: [{ key: "A", text: "直接夸 TA、说感谢和爱", scores: { loveLanguage: { words: 4 } } }, { key: "B", text: "帮 TA 做事，比如做饭、收拾", scores: { loveLanguage: { service: 4 } } }, { key: "C", text: "送 TA 需要或喜欢的东西", scores: { loveLanguage: { gifts: 4 } } }, { key: "D", text: "留出时间一起吃饭、散步、聊天", scores: { loveLanguage: { time: 4 } } }] },
  { id: 72, stage: "STABLE", category: "loveLanguage", text: "纪念日或生日，你更看重？", options: [{ key: "A", text: "TA 用心写的话或当面的表达", scores: { loveLanguage: { words: 4 } } }, { key: "B", text: "TA 留出时间专门陪我", scores: { loveLanguage: { time: 4 } } }, { key: "C", text: "TA 记得并准备的小惊喜/礼物", scores: { loveLanguage: { gifts: 4 } } }, { key: "D", text: "TA 做一桌菜或安排一天行程", scores: { loveLanguage: { service: 4 } } }] },
  { id: 73, stage: "STABLE", category: "loveLanguage", text: "TA 出差或旅行回来，你最期待？", options: [{ key: "A", text: "TA 说「想你了」之类的表达", scores: { loveLanguage: { words: 4 } } }, { key: "B", text: "TA 带的小礼物或特产", scores: { loveLanguage: { gifts: 4 } } }, { key: "C", text: "先抱一下、肢体上的亲近", scores: { loveLanguage: { touch: 4 } } }, { key: "D", text: "TA 留出时间好好陪我", scores: { loveLanguage: { time: 4 } } }] },
  { id: 74, stage: "STABLE", category: "loveLanguage", text: "吵架或冷战和好后，什么最让你感到被在乎？", options: [{ key: "A", text: "TA 认真道歉、说清楚想法", scores: { loveLanguage: { words: 4 } } }, { key: "B", text: "TA 做点事，比如做顿饭、买吃的", scores: { loveLanguage: { service: 4 } } }, { key: "C", text: "TA 送个小东西表示心意", scores: { loveLanguage: { gifts: 4 } } }, { key: "D", text: "TA 放下别的事，专心和我聊一会儿", scores: { loveLanguage: { time: 4 } } }] },
  { id: 75, stage: "STABLE", category: "loveLanguage", text: "下班或周末在家，你更喜欢？", options: [{ key: "A", text: "TA 夸我、说喜欢我", scores: { loveLanguage: { words: 4 } } }, { key: "B", text: "拥抱、牵手、靠在一起", scores: { loveLanguage: { touch: 4 } } }, { key: "C", text: "TA 把饭做好或把事安排好", scores: { loveLanguage: { service: 4 } } }, { key: "D", text: "两个人一起待着，不被打扰", scores: { loveLanguage: { time: 4 } } }] },
  { id: 76, stage: "STABLE", category: "loveLanguage", text: "对方做什么会让你觉得「TA 心里一直有我」？", options: [{ key: "A", text: "主动分享日常、报备行程", scores: { loveLanguage: { words: 3 } } }, { key: "B", text: "记得我提过的东西并买给我", scores: { loveLanguage: { gifts: 4 } } }, { key: "C", text: "我累的时候主动分担家务、跑腿", scores: { loveLanguage: { service: 4 } } }, { key: "D", text: "愿意放下手机，专心听我说话", scores: { loveLanguage: { time: 4 } } }] },
  { id: 77, stage: "STABLE", category: "loveLanguage", text: "你更喜欢收到什么样的心意？", options: [{ key: "A", text: "一条走心的消息或手写卡片", scores: { loveLanguage: { words: 4 } } }, { key: "B", text: "一份用心挑的礼物", scores: { loveLanguage: { gifts: 4 } } }, { key: "C", text: "TA 为我做的一顿饭或一件事", scores: { loveLanguage: { service: 4 } } }, { key: "D", text: "TA 推掉别的安排，专门留时间陪我", scores: { loveLanguage: { time: 4 } } }] },
  { id: 78, stage: "STABLE", category: "loveLanguage", text: "表达爱意时，你更习惯？", options: [{ key: "A", text: "直接说「爱你」「想你」", scores: { loveLanguage: { words: 4 } } }, { key: "B", text: "用拥抱、牵手表达", scores: { loveLanguage: { touch: 4 } } }, { key: "C", text: "帮 TA 做事、照顾 TA", scores: { loveLanguage: { service: 4 } } }, { key: "D", text: "花时间陪 TA 做 TA 喜欢的事", scores: { loveLanguage: { time: 4 } } }] },
  { id: 79, stage: "STABLE", category: "loveLanguage", text: "伴侣生病或情绪低落时，你更想？", options: [{ key: "A", text: "陪在身边说「有我在」", scores: { loveLanguage: { words: 4 } } }, { key: "B", text: "买药、做饭、照顾 TA", scores: { loveLanguage: { service: 4 } } }, { key: "C", text: "买 TA 喜欢的水果、吃的", scores: { loveLanguage: { gifts: 4 } } }, { key: "D", text: "握着 TA 的手陪着", scores: { loveLanguage: { touch: 4 } } }] },
  // 沟通 communication 4 题
  { id: 80, stage: "STABLE", category: "communication", text: "对伴侣有不满时，你通常会？", options: [{ key: "A", text: "找合适时机直接说", scores: { communication: 4 } }, { key: "B", text: "先忍着，攒多了再说", scores: { communication: 2 } }, { key: "C", text: "用玩笑或暗示表达", scores: { communication: 3 } }, { key: "D", text: "很少说，希望 TA 自己发现", scores: { communication: 1 } }] },
  { id: 81, stage: "STABLE", category: "communication", text: "讨论买房、结婚、要孩子等大事时，你更倾向？", options: [{ key: "A", text: "一起分析利弊，共同做决定", scores: { communication: 4 } }, { key: "B", text: "先听 TA 想法，再说自己想法", scores: { communication: 3 } }, { key: "C", text: "不太想深聊，顺其自然", scores: { communication: 2 } }, { key: "D", text: "容易聊着聊着吵起来", scores: { communication: 1 } }] },
  { id: 82, stage: "STABLE", category: "communication", text: "伴侣工作或家里有事心情不好，你通常？", options: [{ key: "A", text: "先问 TA 想聊还是想静静，尊重 TA", scores: { communication: 4 } }, { key: "B", text: "陪在身边，等 TA 愿意说", scores: { communication: 3 } }, { key: "C", text: "给建议、帮分析", scores: { communication: 2 } }, { key: "D", text: "不太会安慰，有时会躲开", scores: { communication: 1 } }] },
  { id: 83, stage: "STABLE", category: "communication", text: "和伴侣意见不一致时，你通常？", options: [{ key: "A", text: "各退一步，找折中方案", scores: { communication: 4 } }, { key: "B", text: "会说服对方，但也听 TA 理由", scores: { communication: 3 } }, { key: "C", text: "懒得争，听 TA 的", scores: { communication: 2 } }, { key: "D", text: "容易上头，吵完再说", scores: { communication: 1 } }] },
  // 价值观 values 3 题
  { id: 84, stage: "STABLE", category: "values", text: "关于「结婚」或「领证」，你和伴侣？", options: [{ key: "A", text: "有共识，在计划中或已提上日程", scores: { values: 4 } }, { key: "B", text: "顺其自然，不催但也不排斥", scores: { values: 3 } }, { key: "C", text: "两家人的事，要各方面合适再说", scores: { values: 2 } }, { key: "D", text: "觉得形式不重要，在一起就好", scores: { values: 1 } }] },
  { id: 85, stage: "STABLE", category: "values", text: "对于「钱怎么花、谁管钱」，你们？", options: [{ key: "A", text: "一起规划，大额支出会商量", scores: { values: 4 } }, { key: "B", text: "各管各的，共同目标一起存", scores: { values: 3 } }, { key: "C", text: "还没说开，基本各花各的", scores: { values: 2 } }, { key: "D", text: "谁赚得多谁说了算 / 严格 AA", scores: { values: 1 } }] },
  { id: 86, stage: "STABLE", category: "values", text: "关于「要不要孩子、什么时候要」，你们？", options: [{ key: "A", text: "认真聊过，有共识", scores: { values: 4 } }, { key: "B", text: "顺其自然，到时候再说", scores: { values: 3 } }, { key: "C", text: "还没深入聊", scores: { values: 2 } }, { key: "D", text: "想法不一致，暂时回避", scores: { values: 1 } }] },
  // 生活习惯 lifestyle 3 题
  { id: 87, stage: "STABLE", category: "lifestyle", text: "周末早上，你更喜欢？", options: [{ key: "A", text: "和伴侣一起睡懒觉、吃早午餐", scores: { lifestyle: 4 } }, { key: "B", text: "早起运动或做自己的事，中午再一起", scores: { lifestyle: 3 } }, { key: "C", text: "各睡各的，醒了再说", scores: { lifestyle: 2 } }, { key: "D", text: "希望对方配合我作息，不然会不爽", scores: { lifestyle: 1 } }] },
  { id: 88, stage: "STABLE", category: "lifestyle", text: "家务分工上，你们的做法更接近？", options: [{ key: "A", text: "一起做，谁有空谁多做", scores: { lifestyle: 4 } }, { key: "B", text: "有分工，提前说好", scores: { lifestyle: 3 } }, { key: "C", text: "谁看不下去谁做", scores: { lifestyle: 2 } }, { key: "D", text: "固定谁负责什么，分工明确", scores: { lifestyle: 2 } }] },
